...
function two_atom_simulation(tspan, ψ0, 
    ...
    for i ∈ 1:N
        ...
        [
            ...
            t -> exp(1.0im * phase)*Ω_blue(X1(t)-X0, Y1(t)-Y0, Z1(t), blue_laser_params_first ) / 2.0,
            t -> exp(1.0im * phase)*conj(Ω_blue(X1(t)-X0, Y1(t)-Y0, Z1(t), blue_laser_params_first ) / 2.0),
            ...
            t -> exp(1.0im * phase)*Ω_blue(dist + X2(t) - X0, Y2(t) - Y0, Z2(t), blue_laser_params_second ) / 2.0,
            t -> exp(1.0im * phase)*conj(Ω_blue(dist + X2(t) - X0, Y2(t) - Y0, Z2(t), blue_laser_params_second ) / 2.0),
...
function direct_CZ_simulation1(tspan1, tspan2, ρ_1, 
    atom_params,    trap_params,     
    samples_first, samples_second, 
    red_laser_params_first,    blue_laser_params_first,
    red_laser_params_second,    blue_laser_params_second,
